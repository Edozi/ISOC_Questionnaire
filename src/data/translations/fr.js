const translations = {
  welcome: {
    ...
    duration: "Environ 2–3 minutes",
  },

  introduction: {
    label: "Avant de commencer",

    titleLine1: "Votre expérience",
    ...
    thankYou:
      "Merci pour votre temps précieux et votre contribution.",

    beginButton: "Commencer l'enquête",
  },
  ...
  questionnaire: {
    ...
    scaleInstruction:
      "Sélectionnez un nombre de 1 à 10.",
  ...
  completion: {
    ...
    titleLine1: "Merci d'avoir",
    titleHighlight: "partagé votre expérience.",
